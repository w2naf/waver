FUNCTION OFFTIMES,DATE=date,TIME=time,BEAM=beam,GATE=gate,PARAM=param,max_offTime=max_offTime,INDEX=index,SJUL=sjul,FJUL=fjul,DIAGNOSE=diagnose,STOP=stop
COMMON rad_data_blk
